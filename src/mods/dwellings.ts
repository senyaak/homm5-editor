...
// Measuring and laying out tiles is the same for everything that stands on the
// map (src/mods/footprint.ts); re-exported here for the callers that knew it as
// a dwelling's own.
