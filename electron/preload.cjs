...
const api = {
  ...
  rmgChoices: () => ipcRenderer.invoke('rmg:choices'),
  rmgTemplates: (p) => ipcRenderer.invoke('rmg:templates', p),
  rmgGenerate: (p) => ipcRenderer.invoke('rmg:generate', p),
  rmgTemplateRead: (file) => ipcRenderer.invoke('rmg:template-read', file),
  rmgTemplateSave: (p) => ipcRenderer.invoke('rmg:template-save', p),
  rmgTemplateDelete: (file) => ipcRenderer.invoke('rmg:template-delete', file),
  ...
  installSpell: (p) => ipcRenderer.invoke('mods:install-spell', p),
  updateSpell: (p) => ipcRenderer.invoke('mods:update-spell', p),
  removeSpell: (p) => ipcRenderer.invoke('mods:remove-spell', p),
  spellUses: (p) => ipcRenderer.invoke('mods:spell-uses', p),
  spellData: () => ipcRenderer.invoke('mods:spell-data'),
  ...
  pandoraGet: (id) => ipcRenderer.invoke('pandora:get', { id }),
  pandoraSet: (id, contents) => ipcRenderer.invoke('pandora:set', { id, contents }),
  qolGet: () => ipcRenderer.invoke('qol:get'),
  qolApply: (settings, net) => ipcRenderer.invoke('qol:apply', { settings, net }),
