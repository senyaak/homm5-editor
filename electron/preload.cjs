...
const api = {
  ...
  rmgChoices: (p) => invoke('rmg:choices', p),
  rmgTemplates: (p) => invoke('rmg:templates', p),
  rmgGenerate: (p) => invoke('rmg:generate', p),
  rmgTemplateRead: (p) => invoke('rmg:template-read', p),
  ...
  factionData: () => invoke('mods:faction-data'),
  factionTree: (donor) => invoke('mods:faction-tree', { donor }),
  installFaction: (p) => invoke('mods:install-faction', p),
  updateFaction: (p) => invoke('mods:update-faction', p),
  removeFaction: (p) => invoke('mods:remove-faction', p),
  ...
  pickFactionFile: (kind) => invoke('mods:pick-faction-file', { kind }),
